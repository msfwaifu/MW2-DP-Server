...
#define DEFAULT_MAX_NB_SERVERS 16384

// Maximum number of servers for one given IP address by default
#define DEFAULT_MAX_NB_SERVERS_PER_ADDRESS 64
...
// Max number of characters for a mapname, including the '\0'
#define MAPNAME_LENGTH 64

// Max number of characters for a hostname, including the '\0'
...
// Write current servers to the info file
